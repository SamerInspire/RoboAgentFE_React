...
// components
import LanguageSelector from "src/Core/Components/MainHeader/SelectLanguage";
import Notifications from "src/Core/Components/MainHeader/Notifications";
import UserMenu from "src/Core/Components/MainHeader/UserMenu";
...
const MainHeader = (props) => {
  ...
  const handleCloseLang = (e) => { setShowLang(null); };
