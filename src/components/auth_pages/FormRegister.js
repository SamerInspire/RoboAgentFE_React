...
const FormRegister = ({ handleNext, setUserData, userData, register, errors, handleSubmit }) => {
    ...
    <FormStyle noValidate component="form" onSubmit={handleSubmit((data) => handleNext(data))}>
      ...
      >
        ...
        <TextField
          ...
          helperText={
            !!errors.lastName?.message ? errors.lastName?.message : errors.lastName && t('register.Enter the last name')
          }
        />
      </Box>
      {/* email */}
      ...
      <TextField
        ...
        helperText={errors.phoneNumber && t('register.Enter a valid phone number')}
      ...
      <TextField
        ...
        error={errors.confPassword ? true : false || passwordsInfo.valueConf !== passwordsInfo.valuePass}
        helperText={
          errors.confPassword
            ? t('register.Please Confirm the password')
            : passwordsInfo.valueConf !== passwordsInfo.valuePass && t('register.Passwords did not match')
        }
      />
      {/* submit */}
